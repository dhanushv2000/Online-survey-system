...
urlpatterns = [
    ...
    path('admin-view-pending-survey', views.admin_view_pending_survey_view,name='admin-view-pending-survey'),
    path('approve-survey/<int:pk>', views.approve_survey_view,name='approve-survey'),
    path('reject-survey/<int:pk>', views.reject_survey_view,name='reject-survey'),
    ...
    path('admin_view_result/<int:pk>', views.admin_view_result_view,name='admin_view_result'),
